...
def has_permission(user_info, accessing_data):
    ...
    data_allow = f'{accessing_data}_allow'
    data_deny = f'{accessing_data}_deny'
    
    if data_allow in user_info and data_deny in user_info:
        return False
    if data_allow in user_info:
        return True
    if data_deny in user_info:
        return False
    
    if "*_allow" in user_info and "*_deny" in user_info:
        return False
...
print(has_permission({ "books_allow", "movies_deny" }, "movies"))  # False
print(has_permission({ "books_allow", "movies_deny" }, "books"))  # True
print(has_permission({ "*_allow", "books_allow", "movies_deny" }, "games"))  # True
print(has_permission({ "*_allow", "*_deny" }, "movies"))  # False